const descriptionIcon = `<svg title="Card has Comments" width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        if (descriptionEditors.length !== 0) {
          descriptionEditors.map((editor) => {
            ...
            if (editorID == cardId) {
              ...
              const svgContainer = card.querySelector(".card-svgs .description_svg");
