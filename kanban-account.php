    ...
    <div class="kanban_container">
        <div class="kanban_user_info">
			<div class="user_profile_image">
				<?php echo get_avatar($current_user_id, 256); // Get user avatar with size 128 ?>
			</div>
			<div class="user_profile_right">
				...
				<div class="user_info_bottom">
					...
					<div class="user_profile_details">
						...
						<p><span><?php _e('Last Name', 'kanban'); ?>:</span> <?php echo esc_html(get_the_author_meta('email', $current_user_id)); ?></p>
					</div>
				</div>
